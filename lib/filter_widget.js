...
FilterWidget.filter = function(entries, value, caseSensitive, callback) {
	return $.map(entries, function(entry, i) {
		var match = startsWith(entry, value, caseSensitive);
		if(callback) {
...
FilterWidget.prototype.onFilter = function(ev) {
	...
	FilterWidget.filter(names, input, caseSensitive, function(match, name, i) {
